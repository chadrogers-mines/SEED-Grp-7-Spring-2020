...
#define DESIREDFEET 5               //This will be TA assigned for task 2, 1ft for task 3
...
float Ki = (0.0);
float Kp = (0.05);
float Ka = (0); // angular velocity proportional coefficient
//////////////////////////////////////////////////////////////////////////////////////////////////////////
void setup() {
...
outputLeft = constrain((abs( -errorLeft * Kp + integralLeft * Ki - Ka*angularVelocity)), 0, 255);
outputRight = constrain((abs(-errorRight * Kp + integralRight * Ki + Ka*angularVelocity)), 0, 255);
